  ...
  <div class="UnidadSesion">
    <div>
      <div class="sesion-header">
        <h1 v-text="sesion.text"></h1>
        <div class="sesion-dates">{{ $ts(sesion.fechaInicial, 'day') }} - {{ $ts(sesion.fechaFinal, 'day') }}</div>
      </div>
      ...
      <div class="ui-row --top">
        ...
        >
          <h2>Actividades</h2>
          <div v-html="sesion.actividades"></div>
        </section>
        <section
        ...
        >
          <h2>Evaluacion</h2>
          <div v-html="sesion.evaluacion"></div>
        </section>
        <section
        ...
        >
          <h2>Competencias</h2>
          <div v-html="sesion.competencias"></div>
        </section>
      </div>

      <section class="refuerzos">
        <h2>Refuerzos</h2>
        <div v-text="sesion.refuerzos"></div>
      </section>
    </div>
  </div>
</template>
