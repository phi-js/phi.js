    ...
    <table>
      <thead>
        <tr>
          <th v-for="(col, i) in columns" :key="i">
            <component v-if="col.slotHeader" :is="col.slotHeader"></component>
            <div v-else>{{ col.props.header || 'Sin titulo' }}</div>
          </th>
        </tr>
      </thead>
      ...
      <tbody>
        <tr v-for="(item, i) in data" :key="i">
          <td v-for="(col, ci) in columns" :key="ci" class="column">
            <component
            ...
            ></component>
            <div v-else-if="columnValues[i][ci]">{{ columnValues[i][ci] }}</div>
          </td>
        </tr>
      </tbody>
      ...
      <tfoot>
        <tr>
          <th v-for="(col, i) in columns" :key="i">
            <component v-if="col.slotFooter" :is="col.slotFooter"></component>
          </th>
        </tr>
      </tfoot>
    </table>
